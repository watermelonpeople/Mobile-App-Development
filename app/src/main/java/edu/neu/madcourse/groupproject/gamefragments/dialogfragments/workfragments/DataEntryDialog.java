...
public class DataEntryDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setTitle("Data Entrist")
                .setMessage("Work as a Data Entrist.\nData Entrists handle customer and account data for computer entry.\nRequires GED.\nCosts 35 energy, 2 hunger and 2 mood.\nGrants 140 money.")
